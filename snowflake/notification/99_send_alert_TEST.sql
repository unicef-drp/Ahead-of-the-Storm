...
def main(session):
    ...
    for pair in new_pairs:
        ...
        try:
            ...
            system_msg  = ('You write factual alert email content for UNICEF emergency '
            ...
            email_body = (
                ...
                '<div style="color:white; font-size:0.78em; font-weight:bold; letter-spacing:1.5px; text-transform:uppercase; opacity:0.9;">Ahead of the Storm &nbsp;&mdash;&nbsp; Alert</div>'
