-- ============================================================================
-- Test Script: Verify Materialized Tables Are Populated
-- ============================================================================
-- Run these queries after executing 01_setup_materialized_tables.sql to confirm
-- all 6 tables loaded correctly from stage.
--
-- NOTE: Queries are filtered to country = 'JAM' as a placeholder. Replace with
-- a country code that exists in your stage (e.g. 'PHL', 'VNM', 'TWN').
-- ============================================================================
...
-- ============================================================================
-- Test 2: MERCATOR_TILE_IMPACT_MAT
-- ============================================================================
...
-- Check row counts and ensemble member coverage
SELECT 
    country,
    storm,
    forecast_date,
...
-- ============================================================================
-- Test 4: SCHOOL_IMPACT_MAT and HC_IMPACT_MAT
-- ============================================================================
...
-- ============================================================================
-- Test 5: BASE_ADMIN_MAT
-- ============================================================================

SELECT
    country,
    COUNT(*)        AS row_count,
    COUNT(DISTINCT tile_id) AS distinct_admin_areas
FROM BASE_ADMIN_MAT
WHERE country = 'JAM'
GROUP BY country;
...
-- ============================================================================
-- Test 6: Compare Expected vs Worst-Case (Agent Logic Test)
-- ============================================================================

-- Expected values (from MERCATOR_TILE_IMPACT_MAT)
...
SELECT 
    ...
    CASE 
        ...
        WHEN ev.expected_population / NULLIF(wc.worst_case_population, 0) < 0.01 THEN 'ERROR: Expected << Worst-case (wrong table?)'
